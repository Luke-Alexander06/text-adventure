...
while asking == True:
    ...
    if valg =="A":
        ...
        print("|du blir glad og tar pengene du stiker av med pengene å går til ringo med en gang]")
        print("|å kjøper deg lego mario]")
        print("|finali ending]")
        exit()
    ...
    if valg =="B":
        asking = False
        print("du vokner fra din død")
        print("men du liger ikke på sjuke sengen din du siter på en trone ")
        print("å alle kner til deg")
        print("en ved sinav deg hva vil du ha " + mc + " min here")
        print("du får noen mørke tanker å du sier til han")
        print("JEG VIL HA LEGO MARIO⚡🌩️........")
        print("finali ending")
        exit()
